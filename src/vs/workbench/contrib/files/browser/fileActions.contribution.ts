...
import { ETHERANA_OPEN_SETTINGS_ACTION_ID } from '../../etherana/browser/etheranaSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openEtherana', comment: ['&& denotes a mnemonic'] }, "&&Open Etherana Settings"),
	},
	order: 1
});
