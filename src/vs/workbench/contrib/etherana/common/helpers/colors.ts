...
// gets converted to --vscode-etherana-greenBG, see etherana.css, asCssVariable
registerColor('etherana.greenBG', configOfBG(acceptBG), '', true);
registerColor('etherana.redBG', configOfBG(rejectBG), '', true);
registerColor('etherana.sweepBG', configOfBG(sweepBG), '', true);
registerColor('etherana.highlightBG', configOfBG(highlightBG), '', true);
registerColor('etherana.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
