...
type EtheranaModelType = {
	model: ITextModel | null;
	editorModel: IResolvedTextEditorModel | null;
};

export interface IEtheranaModelService {
	readonly _serviceBrand: undefined;
	initializeModel(uri: URI): Promise<void>;
	getModel(uri: URI): EtheranaModelType;
	getModelFromFsPath(fsPath: string): EtheranaModelType;
	getModelSafe(uri: URI): Promise<EtheranaModelType>;
	saveModel(uri: URI): Promise<void>;

}

export const IEtheranaModelService = createDecorator<IEtheranaModelService>('etheranaModelService');

class EtheranaModelService extends Disposable implements IEtheranaModelService {
	_serviceBrand: undefined;
	static readonly ID = 'etheranaModelService';
	...
	getModelSafe = async (uri: URI): Promise<EtheranaModelType> => {
...
registerSingleton(IEtheranaModelService, EtheranaModelService, InstantiationType.Eager);
