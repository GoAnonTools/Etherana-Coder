...
import { Diff, DiffArea, EtheranaFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	instantlyApplySearchReplaceBlocks(opts: { uri: URI; searchReplaceBlocks: string; explanation?: string }): void;
	instantlyRewriteFile(opts: { uri: URI; newContent: string; explanation?: string }): void;
	...
	// testDiffs(): void;
	getEtheranaFileSnapshot(uri: URI): EtheranaFileSnapshot;
	restoreEtheranaFileSnapshot(uri: URI, snapshot: EtheranaFileSnapshot): void;
}
