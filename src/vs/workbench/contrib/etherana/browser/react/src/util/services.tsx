...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/etherana/common/etheranaSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { EtheranaSettingsState } from '../../../../../../../workbench/contrib/etherana/common/etheranaSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/etherana/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/etherana/common/refreshModelService.js';
import { IEtheranaSettingsService } from '../../../../../../../workbench/contrib/etherana/common/etheranaSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/etherana/browser/extensionTransferService.js'
import { IProjectMemoryService } from '../../../../browser/projectMemoryService.js'
import { ProjectMemoryState } from '../../../../common/projectMemoryTypes.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/etherana/common/metricsService.js'
...
let settingsState: EtheranaSettingsState
const settingsStateListeners: Set<(s: EtheranaSettingsState) => void> = new Set()
...
let projectMemoryState: ProjectMemoryState
const projectMemoryStateListeners: Set<(s: ProjectMemoryState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IEtheranaSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		etheranaCommandBarService: accessor.get(IEtheranaCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
		projectMemoryService: accessor.get(IProjectMemoryService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, etheranaCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		etheranaCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		etheranaCommandBarService.onDidChangeActiveURI(({ uri }) => {
	...
	projectMemoryState = stateServices.projectMemoryService.state
	disposables.push(
		stateServices.projectMemoryService.onDidChangeState(() => {
			projectMemoryState = stateServices.projectMemoryService.state
			projectMemoryStateListeners.forEach(l => l(projectMemoryState))
		})
	)
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IEtheranaSettingsService: accessor.get(IEtheranaSettingsService),
		...
		IEtheranaModelService: accessor.get(IEtheranaModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IEtheranaCommandBarService: accessor.get(IEtheranaCommandBarService),
		...
		IProjectMemoryService: accessor.get(IProjectMemoryService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Etherana useAccessor was called before _registerServices!`)
	}
...
export const useProjectMemoryState = () => {
	...
	useEffect(() => {
		ss(projectMemoryState)
		projectMemoryStateListeners.add(ss)
		return () => { projectMemoryStateListeners.delete(ss) }
	}, [ss])
	return s
}
