...
import { TextAreaFns, EtheranaInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, EtheranaChatArea } from '../sidebar-tsx/SidebarChat.js';
import { ETHERANA_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/etherana/common/etheranaSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const loadingIcon = <div
		className="@@codicon @@codicon-loading @@codicon-modifier-spin @@codicon-no-default-spin text-etherana-fg-3"
	/>
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(ETHERANA_CTRL_K_ACTION_ID)?.getLabel()
