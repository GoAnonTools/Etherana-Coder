	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--etherana-fg-1)',
						'--tw-prose-headings': 'var(--etherana-fg-1)',
						'--tw-prose-lead': 'var(--etherana-fg-2)',
						'--tw-prose-links': 'var(--etherana-link-color)',
						'--tw-prose-bold': 'var(--etherana-fg-1)',
						'--tw-prose-counters': 'var(--etherana-fg-3)',
						'--tw-prose-bullets': 'var(--etherana-fg-3)',
						'--tw-prose-hr': 'var(--etherana-border-4)',
						'--tw-prose-quotes': 'var(--etherana-fg-1)',
						'--tw-prose-quote-borders': 'var(--etherana-border-2)',
						'--tw-prose-captions': 'var(--etherana-fg-3)',
						'--tw-prose-code': 'var(--etherana-fg-0)',
						'--tw-prose-pre-code': 'var(--etherana-fg-0)',
						'--tw-prose-pre-bg': 'var(--etherana-bg-1)',
						'--tw-prose-th-borders': 'var(--etherana-border-4)',
						'--tw-prose-td-borders': 'var(--etherana-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'etherana-bg-1': 'var(--etherana-bg-1)',
				'etherana-bg-1-alt': 'var(--etherana-bg-1-alt)',
				'etherana-bg-2': 'var(--etherana-bg-2)',
				'etherana-bg-2-alt': 'var(--etherana-bg-2-alt)',
				'etherana-bg-2-hover': 'var(--etherana-bg-2-hover)',
				'etherana-bg-3': 'var(--etherana-bg-3)',


				'etherana-fg-0': 'var(--etherana-fg-0)',
				'etherana-fg-1': 'var(--etherana-fg-1)',
				'etherana-fg-2': 'var(--etherana-fg-2)',
				'etherana-fg-3': 'var(--etherana-fg-3)',
				// 'etherana-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'etherana-fg-4': 'var(--etherana-fg-4)',

				'etherana-warning': 'var(--etherana-warning)',

				'etherana-border-1': 'var(--etherana-border-1)',
				'etherana-border-2': 'var(--etherana-border-2)',
				'etherana-border-3': 'var(--etherana-border-3)',
				'etherana-border-4': 'var(--etherana-border-4)',

				'etherana-ring-color': 'var(--etherana-ring-color)',
				'etherana-link-color': 'var(--etherana-link-color)',
