...
// const voidViewIcon = registerIcon('etherana-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the Etherana Coder chat view.'));

// called VIEWLET_ID in other places for some reason
export const ETHERANA_VIEW_CONTAINER_ID = 'workbench.view.void'
export const ETHERANA_VIEW_ID = ETHERANA_VIEW_CONTAINER_ID

// Register view container
const viewContainerRegistry = Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry);
const container = viewContainerRegistry.registerViewContainer({
	id: ETHERANA_VIEW_CONTAINER_ID,
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "Etherana" (Ctrl + L)
	ctorDescriptor: new SyncDescriptor(ViewPaneContainer, [ETHERANA_VIEW_CONTAINER_ID, {
...
viewsRegistry.registerViews([{
	...
	name: nls.localize2('etheranaChat', ''), // this says ... : CHAT
...
// open sidebar
export const ETHERANA_OPEN_SIDEBAR_ACTION_ID = 'etherana.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: ETHERANA_OPEN_SIDEBAR_ACTION_ID,
			title: 'Open Etherana Coder Sidebar',
		})
	}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupEtheranaSidebar';
	constructor(
		@ICommandService private readonly commandService: ICommandService,
	) {
		this.commandService.executeCommand(ETHERANA_OPEN_SIDEBAR_ACTION_ID)
	}
}
