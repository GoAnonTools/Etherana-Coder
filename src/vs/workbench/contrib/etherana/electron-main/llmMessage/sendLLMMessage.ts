...
import { displayInfoOfProviderName } from '../../common/etheranaSettingsTypes.js';
...
export const sendLLMMessage = async ({
	...
	const onError: OnError = ({ message: errorMessage, fullError }) => {
		...
		if (errorMessage === 'TypeError: fetch failed')
			errorMessage = `Failed to fetch from ${displayInfoOfProviderName(providerName).title}. This likely means you specified the wrong endpoint in Etherana Coder's Settings, or your local model provider like Ollama is powered off.`
