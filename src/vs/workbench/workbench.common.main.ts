...
//#region --- Etherana
import './contrib/etherana/browser/etherana.contribution.js'; // Etherana added this
//#endregion
...
// Chat
// Etherana - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
